...
# Побудова базової моделі для порівняння оптимізаторів та активаторів, шарів Dense (повнозв'язних) мереж з різними параметрами 
...
# Навчання моделей з різними оптимізаторами та збереження історії навчання для кожного оптимізатора
...
print(f"Тестова втрата: {test_loss}, Тестова середня абсолютна помилка (MAE): {test_mae}")
